...
$stmt = $db->prepare("SELECT * FROM users u join user_profile up using(user_id) WHERE user_id = :user_num");
...
<body>
    ...
    <div id="businessRegistrationModal" class="modal">
    <div class="modal-content">
        ...
        <div class="card">
            ...
            <form action="database-php/business_regdb.php" method="POST">
                ...
                <label for="contactInfo">BIO:</label>
    ...
    <div class="container">
        <div class="profile-header">
            ...
            <h1 class="profile-name" id="displayName"><?php echo $user["fname"]; ?> <?php echo $user["lname"]; ?></h1>
    ...
    <div class="modal-content">
        ...
        <form action="database-php/editdb.php" method="POST" id="editForm" class="edit-profile" enctype="multipart/form-data">
            ...
            <textarea id="bio" name="bio" rows="4" placeholder="Hi, I'm new here! Please be nice to me." ></textarea>
